...
const Profile = () => {
  return (
    <Layout title="Profile">
      <div className="flex flex-col items-center bg-gray-200 rounded-lg border shadow-2xl md:flex-row md:max-w-xl px-7 py-5">
        <Image
          className="object-cover w-full h-96 rounded-full md:h-auto md:w-60 md:rounded-full"
          src="/demo1.jpg"
          width={200}
          height={200}
        />
        <div className="flex flex-col justify-center p-5 leading-normal text-gray-700">
          ...
          <div className="mx-4 mb-5 text-center">
            ...
            <p className="text-xs my-2">Yuta Nakamura</p>
            <p className="font-bold mt-2 ">Age</p>
            <p className="text-xs my-2">26</p>
            <p className="font-bold mt-2">E-mail</p>
            <p className="text-xs my-2">n.you0611@gmail.com</p>
            <p className="font-bold mt-2">Phone</p>
            <p className="text-xs my-2">080-1503-6453</p>
