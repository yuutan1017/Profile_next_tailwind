...
export default function HomePage() {
    return (
          <div class="container px-5 py-24 mx-auto flex flex-wrap">
            <div class="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start mx-3">
              <div class="w-full sm:p-4 px-4 mb-6">
                <h1 class="title-font font-medium text-3xl mb-10 text-gray-900">
            ...
            <div className="container lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden sm:mt-0 m-4 px-10 pb-5">
              <div className="flex flex-col items-center bg-gray-200 rounded-lg shadow-2xl px-7 py-5">
                <div className="flex flex-col justify-center leading-normal text-gray-700">
                  ...
                  <div className="mx-4 mb-5 text-center font-bold">
                ...
                <Image
                  className="object-cover rounded w-full h-96 md:h-auto md:w-60 md:rounded"
                  src="/demo1.jpg"
                  width={450}
                  height={300}
                />
