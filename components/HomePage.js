...
export default function HomePage() {
  return (
    <div class="container py-24 mx-auto flex">
      <div class="flex flex-wrap mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start m-4 px-10">
        <div class="w-full sm:p-4 px-4 mb-6">
          <h1 class="title-font font-medium text-4xl mb-10 text-gray-900">
      ...
      <div className="container lg:w-1/2 sm:w-1/3 w-full  m-4 px-10">
        <div className="flex bg-gray-100 px-7 py-5 shadow-xl shadow-slate-400">
          <div className="flex flex-col justify-center text-gray-700">
            <h5 className="text-2xl ml-3 mb-6">
              My Profile
            </h5>
          ...
          <Image
            className="object-cover rounded-full w-full h-96 md:h-auto md:w-60"
            src="/demo1.jpg"
            width={450}
            height={450}
          />
